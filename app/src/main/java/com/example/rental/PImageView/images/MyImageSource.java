package com.example.rental.PImageView.images;
...
public class MyImageSource implements ImageSource {
    ...
    private int mOriginWidth = 900;
    private int mOriginHeight = 900;

    public MyImageSource(String mediaId, int originWidth, int originHeight) {
        mMediaId = mediaId;
